		...
		<div class="xs:mb-6 md:mb-5 flex" :class="{ 'justify-end': props.self }">
			...
			<div class="flex items-end">
				...
				<div
					...
					:class="{
						'rounded-tl ml-4 order-2 bg-sky-500 dark:bg-gray-600':
							props.self && !props.selected,

						'rounded-tr mr-4 bg-gray-200 dark:bg-gray-600':
							!props.self && !props.selected,

						'rounded-tl ml-4 order-2 bg-sky-200 dark:bg-sky-500':
							props.self && props.selected,

						'rounded-tr mr-4 bg-sky-200 dark:bg-sky-500':
							!props.self && props.selected,
					}"
				>
					<!--reply to-->
