...
<template>
	<div class="select-none">
		<button
			...
			"
			class="border-solid border-2 w-full h-[92px] px-5 py-6 mb-3 flex rounded focus:bg-sky-50 dark:active:bg-gray-600 dark:focus:bg-gray-600 dark:hover:bg-gray-600 hover:bg-sky-50 active:bg-sky-100 focus:outline-none transition duration-500 ease-out"
			:class="{
				'md:bg-sky-50': props.isActive,
				'md:dark:bg-gray-600': props.isActive,
			}"
		>
			<!--profile image-->
			<div class="mr-4">
				<img :src="getAvatar()" class="w-7 h-7 rounded-full bg-cover bg-center" />
			</div>
			...
			<div class="w-full flex flex-col">
				...
				<div class="flex justify-between">
					...
					<div v-if="props.conversation.unread">
						<div
							class="w-[18px] h-[18px] flex justify-center items-center rounded-[50%] bg-sky-300"
						>
