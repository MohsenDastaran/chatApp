	...
	<div class="xs:mb-0 md:mb-6">
		...
		>
			...
			<div
				...
				class="absolute right-0 top-3 w-5 h-5 flex items-center justify-center outline-none bg-sky-400 text-xs text-white border border-white dark:border-gray-800 rounded-full transition duration-500"
			>
				{{ props.notifications }}
			</div>
		</button>
