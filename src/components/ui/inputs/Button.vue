...
const variantClasses = computed(() => {
	...
	if (props.variant === "outlined") {
		if (props.color === "success") {
			...
			return {
                ...
                hover:bg-sky-300 dark:hover:border-indigo-400 dark:hover:bg-sky-400
                dark:focus:border-indigo-400 dark:focus:bg-sky-400 active:ring 
                active:ring-indigo-100 focus:ring focus:ring-indigo-100 focus:bg-sky-300`,
				typography: "button-2",
			};
		}
	}
	...
	// ghost buttons.
		...
		if (props.color === "success") {
			...
			return {
				button: `hover:bg-sky-50 hover:text-indigo-400 active:bg-sky-100 
                dark:hover:bg-gray-600`,
				typography: "button-3",
			};
		}
	...
	// contained buttons.
		...
		if (props.color === "success") {
			...
			return {
				button: `bg-sky-300 dark:bg-sky-400 active:ring active:ring-indigo-200',
