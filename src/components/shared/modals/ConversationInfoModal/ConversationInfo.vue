	...
	<div>
		<div class="mb-6 px-5 flex justify-between items-center">
			...
			<button
				...
				"
				class="group p-2 border rounded-full border-gray-200 dark:border-white dark:border-opacity-70 focus:outline-none focus:border-indigo-100 focus:bg-sky-100 hover:bg-sky-100 hover:border-indigo-100 dark:hover:border-indigo-400 dark:hover:bg-sky-400 dark:focus:bg-reindigod-400 dark:focus:border-indigo-400 transition-all duration-200 outline-none"
			>
				<ArrowUturnLeftIcon
		...
		<div class="w-full py-5 border-t border-gray-100 dark:border-gray-700">
			...
			<!--(group) members-->
			<div
				v-if="['group', 'broadcast'].includes(conversation.type) && !props.contact"
		...
		<div class="w-full border-t border-gray-100 dark:border-gray-700">
			...
			>
				<InfoItem :icon="NoSymbolIcon" title="block contact" link color="danger" />
			</div>
			...
			<div
				...
				class="px-5 pt-5 group"
			>
				<InfoItem :icon="TrashIcon" title="delete contact" link color="danger" />
			</div>
